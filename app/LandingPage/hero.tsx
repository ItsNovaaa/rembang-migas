...
export default function Hero() {
  return (
    <section>
      <div className="relative z-10 flex flex-col min-h-screen pt-36 mb:pb-10">
        <div className="flex-1 flex flex-col items-center justify-center text-center px-4 pt-16 md:pt-32">
        ...
        <div className="relative z-20 w-full max-w-sm md:max-w-xl mx-auto px-4 pb-40 md:pt-10">
