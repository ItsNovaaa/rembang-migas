...
const milestones = [
  {
    ...
    description:
      "Green Power didirikan dengan visi menjadi pelopor transisi energi di Indonesia, dimulai dengan proyek percontohan di Jawa Timur.",
  },
  {
    year: "2021",
    title: "Ekspansi Sektor Hulu",
    description:
      "Berhasil mengakuisisi 10% Participating Interest (PI) di blok migas strategis dan memulai operasi lifting perdana.",
  },
  {
    year: "2022",
  ...
  {
    year: "2023",
    title: "Integrasi Digital & AI",
    description:
      "Mengimplementasikan sistem manajemen energi berbasis AI untuk meningkatkan efisiensi operasional hingga 30%.",
  },
  {
    year: "2024",
    title: "Penghargaan Nasional",
    description:
      "Meraih penghargaan 'Best Sustainable Energy Company' atas komitmen terhadap pengurangan emisi karbon.",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto">
            Setiap langkah adalah bukti komitmen kami untuk masa depan energi yang lebih baik.
          </p>
        </div>
